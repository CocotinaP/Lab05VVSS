...
//    private WebElementFacade rightButtonList;
    ...
    public boolean file_exists(String filename) {
        return listOfDirectories.containsText(filename);
    }

    // VERIFICĂ DACĂ FIȘIERUL NU MAI EXISTĂ
    public boolean file_not_exists(String filename) {
        return !listOfDirectories.containsText(filename);
    }

    public void click_edit() {
        click_element_by_attribute_value(buttonList, "value", "Edit");
    }

    public void click_edit_for_file(String filename) {
